...
-- Debug: SELECT * FROM ORDERS_V LIMIT 100;


CREATE OR REPLACE VIEW DAILY_WEATHER_V
AS
SELECT 
    HD.*,
...
FROM HOL_WEATHERSOURCE_DB.ONPOINT_ID.HISTORY_DAY HD
JOIN HOL_WEATHERSOURCE_DB.ONPOINT_ID.POSTAL_CODES PC
...
-- Debug: SELECT * FROM DAILY_WEATHER_V WHERE COUNTRY_DESC = 'Germany' AND CITY_NAME = 'Hamburg' AND YEAR(DATE_VALID_STD) = '2022' AND MONTH(DATE_VALID_STD) = '2' LIMIT 100;
